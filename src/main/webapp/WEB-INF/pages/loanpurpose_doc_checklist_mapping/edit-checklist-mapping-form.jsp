...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class ="container" >
            ...
            <form:form method="POST" class="form-horizontal" commandName="dcmap" action="${pageContext.request.contextPath}/ProductDocumentChecklistMapping/editMapping/${dcmap.pdcid}.html">
