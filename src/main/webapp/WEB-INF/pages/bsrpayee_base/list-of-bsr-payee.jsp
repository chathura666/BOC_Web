...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>List of BSR Payees</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div>
                    <h3 style="margin-top: 10px;">List of BSR Payees</h3>
                    <div>
                        <div>
                ...
                <table style="text-align: left;" id="datatable" class="display" cellspacing="0"  width="100%" >
                    ...
                    <thead>
                        <div style="float:right">
                            <a href="${pageContext.request.contextPath}/bsrpayee/addPayee.html" class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal" style="width:110px;margin-bottom: 5px">+ Add New</a>
                        </div>
                        <tr>
                            <td>PAYEE ID</td>
                            <td>PAYEE</td>
                            ...
                            <td>FEE PLAN</td>
                            <td>CURRENCY</td>
                            <td>COMPROF DR AC SV</td>
                            <td>COMPROF DR AC DD</td>
                    ...
                    <tbody>
                        <c:forEach var="payee" items="${payees}">
                            <tr>
                                <td>${payee.payeeId}</td>
                                <td>${payee.payee}</td>
                                <td>${payee.payeeType}</td>
                                <td>${payee.targetType}</td>
                                <td>${payee.accountNo}</td>
                                <td>${payee.targetDescription}</td>
                                <td>${payee.feePlan}</td>
                                <td>${payee.currency}</td>
                                <td>${payee.comprofDrAcSv}</td>
                                <td>${payee.comprofDrAcDd}</td>

                                <td style="width: 5%;"><p data-placement="top" title="Edit"><button class="btn btn-primary btn-s" data-title="Edit" data-toggle="modal" style="width:60px"  data-target="#edtModalcnfm_${payee.payeeId}" >Edit</button></p></td>
                                <td style="width: 5%;"><p data-placement="top" id="deletebtn"  title="Delete"><button class="btn btn-warning btn-s" data-title="Delete" style="width:60px"  data-toggle="modal" data-target="#dltModalcnfm_${payee.payeeId}" >Delete</button></p></td>
                            </tr>             
                            <div id="dltModalcnfm_${payee.payeeId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-warning" href="${pageContext.request.contextPath}/bsrpayee/deletePayee/${payee.payeeId}.html" title="Delete"><i class="fa fa-trash-o"></i>Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>  

                            <div id="edtModalcnfm_${payee.payeeId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <a  href="${pageContext.request.contextPath}/bsrpayee/editPayee/${payee.payeeId}.html" data-toggle="modal" data-dismiss="modal" class="btn btn-warning" data-target="#myModal" ><i class="fa fa-trash-o"></i>Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
