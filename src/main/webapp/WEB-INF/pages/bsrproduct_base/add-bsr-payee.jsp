            ...
            <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">  
                ...
                <body>
                    <div class ="container" >
                        ...
                        <div class="col-sm-9 col-sm-offset-3"><p>Here you can add product details....</p></div>
                        <form:form method="POST" class="form-horizontal" commandName="product" action="${pageContext.request.contextPath}/bsrproduct/addProduct.html">
                            <div class="form-group">
                                <label  class="col-sm-3 control-label">PRODUCT ID:</label>
                                <div class="col-sm-4">
                                    <form:input id="pid" type="text" class="form-control"  path="productId"/>
                                </div>
                            </div>
                            <div class="form-group">
