            ...
            <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">  
                ...
                <body>
                    <div class ="container" >
                        ...
                        <form:form method="POST" class="form-horizontal" commandName="payee" action="${pageContext.request.contextPath}/bsrpayee/editAreaBase/${payee.payeeId}.html">
                            <div class="form-group">
                                <label  class="col-sm-3 control-label">PAYEE ID:</label>
                                <div class="col-sm-4">
                                    <form:input id="pid" type="text" class="form-control" readonly="true" path="payeeId"/>
                                </div>
                            </div>
                            <div class="form-group">
