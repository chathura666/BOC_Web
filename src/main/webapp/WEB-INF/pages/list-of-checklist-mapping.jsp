            ...
            <div class="container">
                ...
                <div class="row">
                    <div style="float:right">
                            <a href="${pageContext.request.contextPath}/dcmap/addChecklistMap.html" class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal" style="width:110px">+ Add New</a>
                        </div>
                    </div>
