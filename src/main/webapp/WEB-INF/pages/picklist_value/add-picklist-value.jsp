    ...
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">  
            <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">  
                ...
                <body>
                    <div class="container" >
                        <div class="col-sm-9 col-sm-offset-3"><h3>Add Pick List Value</h3></div>
                        <div class="col-sm-9 col-sm-offset-3"><p>Here you can add a new pick list value....</p></div>
                        <form:form method="POST" class="form-horizontal" role="form" commandName="pklist" action="${pageContext.request.contextPath}/picklist/addPickList.html">        
                            <div class="form-group">
                                <label  class="col-sm-3 control-label">PICKLIST ID:</label>
                                <div class="col-sm-4">
                                    <form:input type="text" class="form-control" path="picklistId" maxlength="6"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <button type="submit" class="btn btn-primary btn-block">Add PickList</button>
                                </div>
                                <div class="col-sm-2">
                                    <a href="${pageContext.request.contextPath}/picklist/listPickList.html" type="button" class="btn btn-default btn-block">Close</a>
                                </div>
