 ...
 */
@Embeddable
public class QrtzCronTriggersPK implements Serializable {
    ...
    public QrtzCronTriggersPK() {
    }

    public QrtzCronTriggersPK(String triggerName, String triggerGroup) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QrtzCronTriggersPK)) {
            return false;
        }
        QrtzCronTriggersPK other = (QrtzCronTriggersPK) object;
    ...
    public String toString() {
        return "db.QrtzCronTriggersPK[ triggerName=" + triggerName + ", triggerGroup=" + triggerGroup + " ]";
    }
