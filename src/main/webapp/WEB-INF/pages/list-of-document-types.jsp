                    ...
                    <tbody>
                        <c:forEach var="dtbase" items="${dtbases}">
                            <tr>
                                ...
                                <td ><p data-placement="top" title="Edit"><button class="btn btn-primary btn-s" data-title="Edit" data-toggle="modal" style="width:60px"  data-target="#edtModalcnfm_${dtbase.did}" >Edit</button></p></td>
                                <td><p data-placement="top" id="deletebtn"  title="Delete"><button class="btn btn-warning btn-s" data-title="Delete" style="width:60px"  data-toggle="modal" data-target="#dltModalcnfm_${dtbase.did}" >Delete</button></p></td>
