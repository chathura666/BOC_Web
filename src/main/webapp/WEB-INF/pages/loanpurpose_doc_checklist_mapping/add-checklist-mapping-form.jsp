            ...
            <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">  
                ...
                <body>
                    <div class ="container" >
                        ...
                        <form:form method="POST" class="form-horizontal" commandName="dcmap" action="${pageContext.request.contextPath}/LoanPurposesDocumentChecklistMapping/addMapping.html">
                            <div class="form-group">
                                <label  class="col-sm-3 control-label">PURPOSE:</label>
                                <div class="col-sm-4">
                                    <form:select data-live-search="true" class="form-control" type="text" name="purpose" path="">
                                        <form:options items="${Purposes}"></form:options>                                                                                                        
                                    </form:select>
                                </div>
                            </div>
