...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Edit BSR Bank Branch</title>
        <meta name="viewport" content="width=device-width, initial-scale=1">  
            <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">  
                ...
                <body>
                    <div class ="container" >
                        <div class="col-sm-9 col-sm-offset-3"><h3>Edit BSR Bank Branch</h3></div>
                        <div class="col-sm-9 col-sm-offset-3"><p>Here you can edit BSR bank branch....</p></div>
                        <form:form method="POST" class="form-horizontal" commandName="bbase" action="${pageContext.request.contextPath}/bsrbase/editBsrBankBranch/${bbase.bbId}.html">
                            <div class="form-group">
                                <label  class="col-sm-3 control-label">BB_ID:</label>
                                <div class="col-sm-4">
                                    <form:input id="pid" type="text" class="form-control" readonly="true"  path="bbId"/>
                                </div>
                            </div>
                            <div class="form-group">
