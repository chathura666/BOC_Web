            ...
            <div class="container-fluid row">
                ...
                <div style="margin-top: 7px;" class="col-md-3">
                    <select  id="tablelist"  onchange="redirect_url()" class="selectpicker" data-live-search="true">
                        ...
                        <option selected data-tokens="document" value="${pageContext.request.contextPath}/DocumentTypeBase/listBases.html" onclick="redirect_url(this.value)">DOCUMENT TYPE BASE</option>
                ...
                <table style="text-align: left;" id="datatable" class="display" cellspacing="0"  width="100%" >
                    ...
                    <thead>
                        <div style="float:right">
                            <a href="${pageContext.request.contextPath}/DocumentTypeBase/addBase.html" class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal" style="width:110px;margin-bottom: 5px">+ Add New</a>
                        </div>
                        <tr>
                            <td>DOCUMENT ID</td>
                            <td>PRODUCT TYPE</td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-warning" href="${pageContext.request.contextPath}/DocumentTypeBase/deleteBase/${dtbase.did}.html" title="Delete"><i class="fa fa-trash-o"></i>Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>  
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <a  href="${pageContext.request.contextPath}/DocumentTypeBase/editBase/${dtbase.did}.html" data-toggle="modal" data-dismiss="modal" class="btn btn-warning" data-target="#myModal" ><i class="fa fa-trash-o"></i>Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
