    ...
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">  
            <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">  
                ...
                <body>
                    <div class ="container" >
                        <div class="col-sm-9 col-sm-offset-3"><h3>Edit CAS Currency</h3></div>
                        <div class="col-sm-9 col-sm-offset-3"><p>Here you can edit currency details....</p></div>
                        <form:form method="POST" class="form-horizontal" commandName="cbase" action="${pageContext.request.contextPath}/cascbase/editAreaBase/${cbase.currencyId}.html">
