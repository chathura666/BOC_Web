...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class ="container" >
            ...
            <div>&nbsp&nbsp</div>
            <form:form method="POST" class="form-horizontal" commandName="abmap" action="${pageContext.request.contextPath}/AreaBranchMap/editMap/${abmap.areaBrId}.html">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <form:select data-live-search="true" class="form-control" type="text" name="bname" path="">
                            <form:option item="${AName}" value="${AName}" selected="true" >${AName}</form:option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <form:select data-live-search="true" class="form-control" type="text" name="aname" path="">
                            <form:option value="${BName}" selected="true" >${BName}</form:option>
