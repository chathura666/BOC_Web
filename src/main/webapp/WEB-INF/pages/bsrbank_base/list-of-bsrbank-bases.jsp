...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>List of BSR Bank Branches</title>
    ...
    <body>
            ...
            <div class="container-fluid row">
                ...
                <div style="margin-top: 7px;" class="col-md-3">
                    <select  id="tablelist"  onchange="redirect_url()" class="selectpicker" data-live-search="true">
                        ...
                        <option selected data-tokens="bsrbranch" value="${pageContext.request.contextPath}/bsrbase/listBsrBankBranch.html" onclick="redirect_url(this.value)">BSR BANK BRANCH BASE</option>
        ...
        <div class="container">
            <div class="row">
                <div>
                    <h3 style="margin-top: 10px;">List of BSR Bank Branches</h3>
                    <div>
                        <div>
                ...
                <table style="text-align: left;" id="datatable" class="display" cellspacing="0"  width="100%" >
                    ...
                    <thead>
                        <div style="float:right">
                            <a href="${pageContext.request.contextPath}/bsrbase/addBsrBankBranch.html" class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal" style="width:110px;margin-bottom: 5px">+ Add New</a>
                        </div>
                        <tr>
                            <td>BB ID</td>
                            <td>BANK CODE</td>
                            <td>BANK NAME</td>
                            <td>BANK NAME DISPLAY</td>
                            <td>BRANCH CODE</td>
                            <td>BRANCH NAME</td>
                            <td>BRANCH NAME DISPLAY</td>                            
                    ...
                    <tbody>
                        <c:forEach var="bbase" items="${bbases}">
                            <tr>
                                <td>${bbase.bbId}</td>
                                <td>${bbase.bankCode}</td>
                                <td>${bbase.bankName}</td>
                                <td>${bbase.bankNameDisplay}</td>
                                <td>${bbase.branchCode}</td>
                                <td>${bbase.branchName}</td>
                                <td>${bbase.branchNameDisplay}</td>

                                <td style="width: 5%;"><p data-placement="top" title="Edit"><button class="btn btn-primary btn-s" data-title="Edit" data-toggle="modal" style="width:60px"  data-target="#edtModalcnfm_${bbase.bbId}" >Edit</button></p></td>
                                <td style="width: 5%;"><p data-placement="top" id="deletebtn"  title="Delete"><button class="btn btn-warning btn-s" data-title="Delete" style="width:60px"  data-toggle="modal" data-target="#dltModalcnfm_${bbase.bbId}" >Delete</button></p></td>
                            </tr>             
                            <div id="dltModalcnfm_${bbase.bbId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-warning" href="${pageContext.request.contextPath}/bsrbase/deleteBsrBankBranch/${bbase.bbId}.html" title="Delete"><i class="fa fa-trash-o"></i>Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>  

                            <div id="edtModalcnfm_${bbase.bbId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <a  href="${pageContext.request.contextPath}/bsrbase/editBsrBankBranch/${bbase.bbId}.html" data-toggle="modal" data-dismiss="modal" class="btn btn-warning" data-target="#myModal" ><i class="fa fa-trash-o"></i>Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
