 ...
 */
@Embeddable
public class QrtzBlobTriggersPK implements Serializable {
    ...
    public QrtzBlobTriggersPK() {
    }

    public QrtzBlobTriggersPK(String triggerName, String triggerGroup) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QrtzBlobTriggersPK)) {
            return false;
        }
        QrtzBlobTriggersPK other = (QrtzBlobTriggersPK) object;
    ...
    public String toString() {
        return "db.QrtzBlobTriggersPK[ triggerName=" + triggerName + ", triggerGroup=" + triggerGroup + " ]";
    }
