            ...
            <div class="container-fluid row">
                ...
                <div style="margin-top: 7px;" class="col-md-3" >
                    <select  id="tablelist"  onchange="redirect_url()" class="selectpicker" data-live-search="true">
                        ...
                        <option selected data-tokens="credit card category wise eligibilites" value="${pageContext.request.contextPath}/cceligibility/listEligibilities.html" onclick="redirect_url(this.value)">CC CARD CATEGORY WISE ELIGIBILITES</option>
                ...
                <table id="datatable" class="display" cellspacing="0" width="100%">
                    <thead>
                        <div style="float:right">
                            <a href="${pageContext.request.contextPath}/cceligibility/addEligibility.html" class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal" style="width:110px;margin-bottom: 5px">+ Add New</a>
                        </div>
                        <tr>
                            <div>
                                <td>CCE_ID</td>
                    ...
                    <tbody>
                        <c:forEach var="eligibility" items="${eligibilities}">
                            <tr>
                                <td>${eligibility.cceId}</td>
                                <td>${eligibility.mainCategory}</td>
                                <td>${eligibility.subCategory}</td>
                                <td>${eligibility.subSelection}</td>

                                <td style="width: 5%;"><p data-placement="top" title="Edit"><button class="btn btn-primary btn-s" data-title="Edit" data-toggle="modal"  style="width:60px"  data-target="#edtModalcnfm_${eligibility.cceId}">Edit</button></p></td>
                                <td style="width: 5%;"><p data-placement="top" id="deletebtn"  title="Delete"><button class="btn btn-warning btn-s" data-title="Delete"  style="width:60px" data-toggle="modal" data-target="#dltModalcnfm_${eligibility.cceId}">Delete</button></p></td>

                            </tr>
                            <div id="dltModalcnfm_${eligibility.cceId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-warning" href="${pageContext.request.contextPath}/cceligibility/deleteEligibility/${eligibility.cceId}.html" title="Delete"><i class="fa fa-trash-o"></i>Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>  

                            <div id="edtModalcnfm_${eligibility.cceId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <a  href="${pageContext.request.contextPath}/cceligibility/editEligibility/${eligibility.cceId}.html" data-toggle="modal" data-dismiss="modal" class="btn btn-warning" data-target="#myModal" ><i class="fa fa-trash-o"></i>Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
