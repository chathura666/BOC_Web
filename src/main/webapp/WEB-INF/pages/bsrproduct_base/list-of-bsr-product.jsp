...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>List of BSR Products</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div>
                    <h3 style="margin-top: 10px;">List of BSR Products</h3>
                    <div>
                        <div>
                ...
                <table style="text-align: left;" id="datatable" class="display" cellspacing="0"  width="100%" >
                    ...
                    <thead>
                        <div style="float:right">
                            <a href="${pageContext.request.contextPath}/bsrproduct/addProduct.html" class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal" style="width:110px;margin-bottom: 5px">+ Add New</a>
                        </div>
                        <tr>
                            <td>PRODUCT ID</td>
                            <td>PRODUCT CODE</td>
                            <td>PRODUCT NAME</td>
                            <td>CURRENCY</td>
                            <td>SO DEBITS ALLOWED</td>
                            <td>SO CREDITS ALLOWED</td>
                            <td>TFR TO LKR AC ALLOWED</td>
                            <td>TFR TO FCY AC ALLOWED</td>
                            <td>IF FCY ALLOWED ELIGIBLE PRODUCT TYPES</td>
                    ...
                    <tbody>
                        <c:forEach var="product" items="${products}">
                            <tr>
                                ...
                                <td>${product.soDebitsAllowed}</td>
                                <td>${product.soCreditsAllowed}</td>
                                <td>${product.tfrToLkrAcAllowed}</td>
                                <td>${product.tfrToFcyAcAllowed}</td>
                                <td>${product.ifFcyAllowedEligibleProductTypes}</td>

                                <td style="width: 5%;"><p data-placement="top" title="Edit"><button class="btn btn-primary btn-s" data-title="Edit" data-toggle="modal" style="width:60px"  data-target="#edtModalcnfm_${product.productId}" >Edit</button></p></td>
                                <td style="width: 5%;"><p data-placement="top" id="deletebtn"  title="Delete"><button class="btn btn-warning btn-s" data-title="Delete" style="width:60px"  data-toggle="modal" data-target="#dltModalcnfm_${product.productId}" >Delete</button></p></td>
                            </tr>             
                            <div id="dltModalcnfm_${product.productId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-warning" href="${pageContext.request.contextPath}/bsrproduct/deleteProduct/${product.productId}.html" title="Delete"><i class="fa fa-trash-o"></i>Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>  

                            <div id="edtModalcnfm_${product.productId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <a  href="${pageContext.request.contextPath}/bsrproduct/editProduct/${product.productId}.html" data-toggle="modal" data-dismiss="modal" class="btn btn-warning" data-target="#myModal" ><i class="fa fa-trash-o"></i>Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
