...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>List of Loan Interest Rate Variances</title>
                ...
                <table style="text-align: left;" id="datatable" class="display" cellspacing="0"  width="100%" >
                    <thead>
                        <div style="float:right">
                            <a href="${pageContext.request.contextPath}/LoanInterestRateVariance/addVariance.html" class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal" style="width:110px;margin-bottom: 5px">+ Add New</a>
                        </div>
                        <tr>
                            <td style="width: 6%;text-align: center">LIRV ID</td>
                            <td>PID</td>
                            <td>VARIANCE FIXED</td>
                            <td>VARIANCE RATE VARIABLE1</td>
                            <td>VARIANCE RATE VARIABLE2</td>
                            <td>MIN_REPAYMENT_PERIOD</td>
                            <td>MAX_REPAYMENT_PERIOD</td>
                    ...
                    <tbody>
                        <c:forEach var="var" items="${vars}">
                            <tr>
                                <td style="width: 6%;text-align: center">${var.lirvId}</td>
                                <td>${var.pid.pid}</td>
                                <td>${var.varianceFixed}</td>
                                <td>${var.varianceRateVariable1}</td>
                                <td>${var.varianceRateVariable2}</td>
                                <td>${var.minRepaymentPeriod}</td>
                                <td>${var.maxRepaymentPeriod}</td>
                                <td style="width: 5%;"><p data-placement="top" title="Edit"><button class="btn btn-primary btn-s" data-title="Edit" data-toggle="modal" style="width:60px"  data-target="#edtModalcnfm_${var.lirvId}" >Edit</button></p></td>
                                <td style="width: 5%;"><p data-placement="top" id="deletebtn"  title="Delete"><button class="btn btn-warning btn-s" data-title="Delete" style="width:60px"  data-toggle="modal" data-target="#dltModalcnfm_${var.lirvId}" >Delete</button></p></td>
                            </tr>             
                            <div id="dltModalcnfm_${var.lirvId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-warning" href="${pageContext.request.contextPath}/LoanInterestRateVariance/deleteVariance/${var.lirvId}.html" title="Delete"><i class="fa fa-trash-o"></i>Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>  

                            <div id="edtModalcnfm_${var.lirvId}" class="modal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <a  href="${pageContext.request.contextPath}/LoanInterestRateVariance/editVariance/${var.lirvId}.html" data-toggle="modal" data-dismiss="modal" class="btn btn-warning" data-target="#myModal" ><i class="fa fa-trash-o"></i>Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
