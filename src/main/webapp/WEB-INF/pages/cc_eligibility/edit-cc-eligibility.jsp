            ...
            <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">  
                ...
                <body>
                    <div class="container">
                        ...
                        <form:form method="POST" class="form-horizontal" role="form" commandName="eligibility" action="${pageContext.request.contextPath}/cceligibility/editEligibility/${eligibility.cceId}.html">
                            <div class="form-group">
                                <label  class="col-sm-3 control-label">CCE ID:</label>
                                <div class="col-sm-4">
                                    <form:input type="text" class="form-control" path="cceId" readonly="true" maxlength="4"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <form:select class="form-control" path="mainCategory" style="margin-top: 6px;width:150px">
                                        <form:options  items="${creditCardBrand}"></form:options>                                                                                                       
                                    </form:select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <form:select class="form-control" path="subCategory" style="margin-top: 6px;width:150px">
                                        <form:options  items="${creditCardCategory}"></form:options>                                         
                                    </form:select>                           
                                </div>
                            </div>
                            <div class="form-group">
