...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Add Area Branch Mapping page</title>
            ...
            <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">  
                ...
                <body>
                    <div class ="container" >
                        ...
                        <div class="col-sm-9 col-sm-offset-3"><p>Here you can add Area Branch Mapping details....</p></div>
                        <div>&nbsp&nbsp</div>    
                        <form:form method="POST" class="form-horizontal" commandName="abmap" action="${pageContext.request.contextPath}/AreaBranchMapping/addMapping.html">
                             <div>&nbsp</div>    
