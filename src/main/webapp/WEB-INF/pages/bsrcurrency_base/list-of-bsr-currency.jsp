...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>List of BSR Currencies</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div>
                    <h3 style="margin-top: 10px;">List of BSR Currencies</h3>
                    <div>
                        <div>
                ...
                <table style="text-align: left;" id="datatable" class="display" cellspacing="0"  width="100%" >
                    ...
                    <thead>
                        <div style="float:right">
                            <a href="${pageContext.request.contextPath}/bsrcbase/addCurrency.html" class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal" style="width:110px;margin-bottom: 5px">+ Add New</a>
                        </div>
                        <tr>
                            <td>CURRENCY ID</td>
                            <td>CURRENCY CODE</td>
                            <td>CURRENCY NAME</td>
                            <td>CURRENCY SHORT NAME</td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-warning" href="${pageContext.request.contextPath}/bsrcbase/deleteCurrency/${cbase.currencyId}.html" title="Delete"><i class="fa fa-trash-o"></i>Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>  
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <a  href="${pageContext.request.contextPath}/bsrcbase/editCurrency/${cbase.currencyId}.html" data-toggle="modal" data-dismiss="modal" class="btn btn-warning" data-target="#myModal" ><i class="fa fa-trash-o"></i>Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
